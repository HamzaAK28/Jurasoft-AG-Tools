...
# Function to print all occurrences of a specific pattern in a given text
...
def compare_patterns(manual_results, trained_results):
    ...
    # print(f"Trained:'{missing_in_trained}")
    ...
    # print(f"Manual: {missing_in_manual}")
...
def process_folders(manual_text_folder, trained_text_folder, missing_patterns_manual_text, missing_patterns_trained_text):
    ...
    for i, (manual_file, trained_file) in enumerate(zip(manual_files, trained_files)):
        ...
        # Find generic patterns in manual text
        manual_generic_patterns = find_generic_patterns(manual_text)
        ...
        # Find generic patterns in trained text
        trained_generic_patterns = find_generic_patterns(trained_text)
    ...
    return manual_results, trained_results, summary_text, missing_patterns_dict
